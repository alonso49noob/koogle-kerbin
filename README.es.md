...
## Límites conocidos (versión web)

- **Solo Kerbin.** Añadir Mun, Minmus o el resto de cuerpos es cuestión de meter
  sus parámetros en `js/config.js` y un selector; no está hecho. La aplicación
  de escritorio sí los tiene todos.
...
- **Sin sombreado de relieve** en 2D.
